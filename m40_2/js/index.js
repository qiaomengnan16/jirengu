/**
 * Created by qiaohao on 2018/11/6.
 */
...
var Footer = {
    ...
    bind: function () {
        ...
        this.$rightBtn.on('click',function () {
            ...
            var itemWidth = Math.floor(_this.$box.find('li').outerWidth(true))
        ...
        this.$leftBtn.on('click',function () {
            ...
            var itemWidth = Math.floor(_this.$box.find('li').outerWidth(true))
            var rowCount = Math.floor(_this.$box.width()/itemWidth)
            console.log((rowCount * itemWidth))
            if(!_this.isToStart){
                _this.isAnimate = true
                _this.$ul.animate({
                    left: '+=' + (rowCount * itemWidth)
...
var Fm = {
    init: function () {
        ...
        this.$btn = this.$container.find('.btn-play')
        this.bind()
    },
    bind: function () {
        var _this = this
        ...
        this.audio.addEventListener('play',function () {
            _this.$btn.removeClass('icon-play').addClass('icon-pause')
        ...
        this.audio.addEventListener('pause',function () {
            _this.$btn.removeClass('icon-pause').addClass('icon-play')
            clearInterval(_this.statusClock)
